...
<?php
  ...
  function updateMessage($messageId, $title, $content) {
    ...
    $qry = "update message set title = '".$title."', content ='".$content."' where id='".$messageId."'";
  ...
  if(isset($_POST['submit'])) {
    ...
    updateMessage($_GET['mid'], $title, $content);
  }
?>
<body>
...
<span class="fl">
<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> 编辑留言
</span>
...
<form name="messageform" onsubmit="return checkMessage();" id="messageform" 
  method="post" action="">
    ...
    <div class="form-group">
      ...
      <textarea name="content" id="message_editor" class="form-control" rows="5" style="width:100%;"><?php echo $row->content?></textarea>
    </div>
    <nav class="navbar navbar-default navbar-fixed-bottom">
  <div class="container-fluid">
    <button type="submit" name="submit" value="确认编辑留言" class="btn btn-success navbar-btn">
    <span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> 确认编辑留言</button>
  </div>
</nav>
</form>
<?php
