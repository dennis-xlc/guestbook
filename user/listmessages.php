...
<?php
  ...
  $qry = "select * from message where user_id = '".$userId."' order by create_time desc";
...
<span class="fl">
<a class="btn btn-success" href="addmessage.php"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 新增留言</a>
</span>
...
<table  class="table table-hover table-bordered">
  <tr class="active" align="center">
    ...
    <td width="50" align="center" class="bgc"><strong>查看</strong></td>
...
?>
  <tr>
    <td colspan="5" align="center">对不起，您还没有任何留言！</td>
  </tr>
<?php
  } else {
...
?>
  <tr>
    ...
    <td align="center"><a class="btn btn-default btn-xs" href="message.php?mid=<?php echo $row['id']?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> 查看</a></td>
    <td align="center">
    <a class="btn btn-primary btn-xs" role="button" href="editmessage.php?mid=<?php echo $row['id']?>">
