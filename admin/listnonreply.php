...
<?php
  ...
  $qry = "select * from message where reply is null order by create_time desc";
...
<span class="fl">
<span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> 待回复留言列表
</span>
...
?>
  <tr>
    <td colspan="5" align="center">对不起，目前没有任何待回复留言！</td>
  </tr>
<?php
  } else {
